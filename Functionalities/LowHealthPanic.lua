...
ParticleEmitter2.Texture = "rbxassetid://116051376626073" -- Yes
...
-- MUST be LocalScript
local Script5 = Instance.new("LocalScript")
...
table.insert(cors, sandbox(Script5, function()
	...
	local sound = part:FindFirstChild("SmokeEffect")
	if not sound then return end

	local particles = {
		part:FindFirstChild("particle1"),
		part:FindFirstChild("particle2")
	}
